...
class Gaussian():
    ...
    def calculate_mean(self):
        ...
        for value in self.data:
            total_sum += value
        return total_sum / float(len(self.data))
    ...
    def calculate_stdev(self, sample=True):
        ...
        total_sum = 0              
        for i in self.data:
            total_sum += (i - self.mean)**2
        denominator = len(self.data) - 1 if sample else len(self.data)
        self.stdev = math.sqrt(total_sum / denominator)
        return self.stdev
    ...
    def pdf(self, x):
        ...
        exponential = (-1/2) * ((x - self.mean)/self.stdev)**2
        pdf = (1 / math.sqrt(2 * math.pi * self.stdev**2)) * math.pow(math.e, exponential)
        return pdf
